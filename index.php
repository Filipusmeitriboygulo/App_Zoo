      ...
      <div id="carouselExampleControls" class="carousel slide hero" data-bs-ride="carousel">
        ...
        <div class="carousel-inner " style="max-height: 910px ; height: 100%; ">
          <div class="carousel-item active">
            <img src="assets/img/banner.jpg" class="d-block w-lg-100 w-100" alt="..." />
          </div>
        ...
        <div class="row row-cols-1 row-cols-md-4 g-4">
          <div class="col">
            <div class="card h-100 bg-body-secondary" style="border: none;">
              <img src="assets/img/wahana1.jpg" class="card-img-top mt-3 w-25 rounded-circle" alt="...">
              <div class="card-body text-center">
                <h5 class="card-title">Gerai Zoovenir</h5>
                <p class="card-text">Lengkapi kunjungan sobat satwa dengan koleksi suvenir yang bisa sobat satwa dapatkan di Gerai Zoovenir</p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card h-100 bg-body-secondary" style="border: none;">
              ...
              <div class="card-body text-center ">
                ...
                <p class="card-text">Presentasi dan Edukasi Satwa (PES) Aves adalah sarana edukasi melalui pengenalan perilaku satwa burung layaknya</p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card h-100 bg-body-secondary" style="border: none;">
              <img src="assets/img/tiger2.jpg" class="card-img-top mt-3  w-25 rounded-circle" alt="...">
              <div class="card-body text-center ">
                <h5 class="card-title">Presentasi Edukasi Mamalia</h5>
                <p class="card-text">Presentasi dan Edukasi Satwa (PES) Mamalia adalah sarana edukasi melalui pengenalan perilaku satwa mamalia layaknya </p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card h-100 bg-body-secondary" style="border: none;">
              ...
              <div class="card-body text-center ">
                ...
                <p class="card-text">Avros menyediakan aneka olahan buah seperti jus, salad buah, sup buah, lotis, serta sandwich, dan sosis bakar.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="carousel-inner">
              ...
              <div class="row row-cols-1 row-cols-md-4 g-4">
                <div class="col">
                  <div class="card h-100">
                    <img src="assets/img/wahana1.jpg" class="card-img-top card-img-fixed w-100" alt="...">
                    <div class="card-img-overlay">
                ...
                <div class="col">
                  <div class="card h-100">
                    <img src="assets/img/wahana2.jpg" class="card-img-top card-img-fixed w-100" alt="...">
                    <div class="card-img-overlay">
                ...
                <div class="col">
                  <div class="card h-100">
                    <img src="assets/img/wahana3.jpg" class="card-img-top card-img-fixed w-100" alt="...">
                    <div class="card-img-overlay">
                ...
                <div class="col">
                  <div class="card h-100">
                    <img src="assets/img/wahana4.jpg" class="card-img-top card-img-fixed w-100" alt="...">
                    <div class="card-img-overlay">
            ...
            <div class="carousel-item">
              <div class="row row-cols-1 row-cols-md-4 g-4">
                <div class="col">
                  <div class="card h-100">
                    <img src="assets/img/wahana5.jpg" class="card-img-top card-img-fixed w-100" alt="...">
                    <div class="card-img-overlay">
                ...
                <div class="col">
                  <div class="card h-100">
                    <img src="assets/img/wahana6.jpg" class="card-img-top card-img-fixed w-100" alt="...">
                    <div class="card-img-overlay">
                ...
                <div class="col">
                  <div class="card h-100">
                    <img src="assets/img/wahana7.jpg" class="card-img-top card-img-fixed w-100" alt="...">
                    <div class="card-img-overlay">
                ...
                <div class="col">
                  <div class="card h-100">
                    <img src="assets/img/wahana8.jpg" class="card-img-top card-img-fixed w-100" alt="...">
                    <div class="card-img-overlay">
